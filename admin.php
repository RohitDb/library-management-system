  ...
  <div class="main">
    <div class="info">
      ...
      <div class="cont">
          ...
          <div class="">
        <button type="submit"  class="cred" name="cred"value="credentials" target="_blank" onclick="usercred()">credentials</button>
...
echo('<script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    function usercred()
    {
      window.location.href="http://localhost/phpmyadmin/index.php?route=/database/structure&server=1&db=sample";
    }
    </script>
</body>
</html>
